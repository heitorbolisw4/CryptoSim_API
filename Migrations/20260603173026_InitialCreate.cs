        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarteiraId1 = table.Column<int>(type: "integer", nullable: true),
                    MoedaId1 = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaldoCriptos_Carteiras_CarteiraId1",
                        column: x => x.CarteiraId1,
                        principalTable: "Carteiras",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaldoCriptos_Moedas_MoedaId1",
                        column: x => x.MoedaId1,
                        principalTable: "Moedas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaldoCriptos_CarteiraId1",
                table: "SaldoCriptos",
                column: "CarteiraId1",
                unique: true);
